package ninja.digitalcloud.application.backend.configurations.filters;
...
public class HTTPRequestResponseLoggingFilter extends OncePerRequestFilter {
    ...
    private final static Logger log = LoggerFactory.getLogger(HTTPRequestResponseLoggingFilter.class);
